  ...
  return (
    <div className="dashboard-wrapper">
      ...
      <main className="dashboard-content">
        ...
        <section className="status-section">
          <div className="status-card blue">
            <h2 className="status-value">{loading ? "..." : summary.total_itens}</h2>
            <p className="status-label">Em Estoque</p>
            <span className="status-sub">Total de itens</span>
          </div>
          <div className="status-card yellow">
            <h2 className="status-value">{loading ? "..." : summary.low_stock}</h2>
            <p className="status-label">Estoque Baixo</p>
            <span className="status-sub">Atenção necessária</span>
          </div>
          <div className="status-card purple">
            <h2 className="status-value">{loading ? "..." : summary.total_maletas}</h2>
            <p className="status-label">Maletas</p>
            <span className="status-sub">Templates criados</span>
          </div>
        </section>
        ...
        <section className="actions-section">
          {/* Scanner */}
          <div className="action-card" onClick={() => window.location.href = "/scanner"}>
          ...
          {/* Maletas */}
          <div className="action-card" onClick={() => window.location.href = "/maletas-list"}>
          ...
          {/* Inventário */}
          <div className="action-card" onClick={() => window.location.href = "/inventory"}>
      ...
      <footer className="bottom-nav">
        ...
        <div className="nav-item" onClick={() => window.location.href = "/inventory"}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
            <line x1="3" y1="6" x2="21" y2="6"></line>
          </svg>
        ...
        <div className="nav-item" onClick={() => window.location.href = "/reports"}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <line x1="18" y1="20" x2="18" y2="10"></line>
            <line x1="12" y1="20" x2="12" y2="4"></line>
            <line x1="6" y1="20" x2="6" y2="14"></line>
